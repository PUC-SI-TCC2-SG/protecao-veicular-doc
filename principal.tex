...
\newcommand{\monog}{AutoJá: Aplicativo móvel que auxilia motoristas de veículos automotores na busca de serviços de reparação.}
\newcommand{\monogES}{AutoJá: Mobile application that assists vehicle drivers in the search for repair services}
\newcommand{\tipo}{Artigo }  % Especificar a seção tipo do trabalho: Artigo, Resumo, Tese, Dociê etc
\newcommand{\origem}{Brasil}
\newcommand{\editorial}{\textbf{Abakos}, Belo Horizonte,v. 1, n. 1, p. 20-04, Abr. 2020 - ISSN: 2175-5841}  % p. xx-xx – páginas inicial-final do artigo
% \newcommand{\lcc}{\scriptsize{Licença Creative Commons Attribution-NonCommercial-NoDerivs 3.0 Unported}}

%%%%%%%%%%%%%%%%%INFORMAÇÕES SOBRE AUTOR PRINCIPAL %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\AutorA}{Lucas Gama Abreu de Melo}
\newcommand{\funcaoA}{}
\newcommand{\emailA}{lga.melo@pucminas.br}
